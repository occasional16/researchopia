...
export class ManagerTool extends BasicTool {
...
export function unregister(tools) {
...
export function makeHelperTool(cls, options) {
...
export function _importESModule(path) {
